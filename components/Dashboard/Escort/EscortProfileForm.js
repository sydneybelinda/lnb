...
const AgencyInfoForm = (props) => {
  ...
  if(escort[s.serviceid]){

    serv[s.serviceid] = true
    //serv.push(s.serviceid)
  } else {
    serv[s.serviceid] = false
  }
  ...
  useEffect(async () => {
    ...
    if (props.escort.files) {
      ...
      props.escort.files.map((file) => {
        files.push({
          source: `${URL}/static/userdata/${escort.username}/images/${file.file}`,
          options: {
            type: "local",
          },
        });
  ...
  return (
    <Formik
      ...
      initialValues={{
        ...
        cim: escort.cim || "",
        cob: escort.cob || "",
        couples: escort.couples || "",
        deepthroat: escort.deepthroat || "",
        domination: escort.domination || "",
        facesitting: escort.facesitting || "",
        fingering: escort.fingering || "",
        fisting: escort.fisting || "",
        footfetish: escort.footfetish || "",
        frenchkissing: escort.frenchkissing || "",
        gfe: escort.gfe || "",
        givinghardsports: escort.givinghardsports || "",
        receivinghardsports: escort.receivinghardsports || "",
        lapdancing: escort.lapdancing || "",
        massage: escort.massage || "",
        oralsex: escort.oralsex || "",
        owo: escort.owo || "",
        pse: escort.pse || "",
        parties: escort.parties || "",
        reverseoral: escort.reverseoral || "",
        givingrimming: escort.givingrimming || "",
        receivingrimming: escort.receivingrimming || "",
        roleplay: escort.roleplay || "",
        sextoys: escort.sextoys || "",
        spanking: escort.spanking || "",
        strapon: escort.strapon || "",
        striptease: escort.striptease || "",
        teabagging: escort.teabagging || "",
        tieandtease: escort.tieandtease || "",
        uniforms: escort.uniforms || "",
        givingwatersports: escort.givingwatersports || "",
        receivingwatersports: escort.receivingwatersports || "",
        webcamsex: escort.webcamsex || "",
        notes: escort.notes || "",
        monday: escort.monday || "",
        tuesday: escort.tuesday || "",
        wednesday: escort.wednesday || "",
        thursday: escort.thursday || "",
        friday: escort.friday || "",
        saturday: escort.saturday || "",
        sunday: escort.sunday || "",
        position: escort.position || "1",
          ...
          <Form noValidate onSubmit={handleSubmit}>
            ...
            <Form.Row>
              ...
              <Form.Group as={Col} md="12" controlId="validationCustom02">
                <Form.Label>Position on Site:</Form.Label>
                <InputGroup hasValidation>
                  <Form.Control
                    type="text"
            ...
            <Form.Row>
              ...
              <Form.Group as={Col} md="12" controlId="validationDesc">
                ...
                <Form.Control
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  isInvalid={touched.otherpicing && errors.otherpricing}
                />
                <Form.Control.Feedback type="invalid"></Form.Control.Feedback>
              </Form.Group>
            </Form.Row>
              ...
              <Form.Group as={Col} md="12" controlId="validationCustom02">
                ...
                <InputGroup hasValidation>
                  <Form.Control
                    ...
                    // onChange={handleFirstNameChange}
                    onBlur={handleBlur}
                    isInvalid={touched.monday && errors.monday}
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <Form.Group as={Col} md="12" controlId="validationCustom02">
                ...
                <InputGroup hasValidation>
                  <Form.Control
                    ...
                    // onChange={handleFirstNameChange}
                    onBlur={handleBlur}
                    isInvalid={touched.tuesday && errors.tuesday}
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <Form.Group as={Col} md="12" controlId="validationCustom02">
                ...
                <InputGroup hasValidation>
                  <Form.Control
                    ...
                    // onChange={handleFirstNameChange}
                    onBlur={handleBlur}
                    isInvalid={touched.wednesday && errors.wednesday}
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <Form.Group as={Col} md="12" controlId="validationCustom02">
                ...
                <InputGroup hasValidation>
                  <Form.Control
                    ...
                    // onChange={handleFirstNameChange}
                    onBlur={handleBlur}
                    isInvalid={touched.thursday && errors.thursday}
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <Form.Group as={Col} md="12" controlId="validationCustom02">
                ...
                <InputGroup hasValidation>
                  <Form.Control
                    ...
                    // onChange={handleFirstNameChange}
                    onBlur={handleBlur}
                    isInvalid={touched.friday && errors.friday}
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <Form.Group as={Col} md="12" controlId="validationCustom02">
                ...
                <InputGroup hasValidation>
                  <Form.Control
                    ...
                    // onChange={handleFirstNameChange}
                    onBlur={handleBlur}
                    isInvalid={touched.saturday && errors.saturday}
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <Form.Group as={Col} md="12" controlId="validationCustom02">
                ...
                <InputGroup hasValidation>
                  <Form.Control
                    ...
                    // onChange={handleFirstNameChange}
                    onBlur={handleBlur}
                    isInvalid={touched.sunday && errors.sunday}
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <FilePond
                ...
                server={{
                  ...
                  remove: (source, load, error) => {
                    var name = source.replace(`${URL}/static/userdata/${escort.username}/images/`, "");


                    console.log(name)

                    deleteFile(name, escort.username);
