...
import { getUser, getAgency, getCities, getSelect, getServices } from "../../utils/Queries";
                ...
                <section className="ps-my-account ps-page--account">
                  <div className="row">
                   ...
                   It is recommended that you do not use your real identity as this information is available publicly. Enter the details of your public escort persona.
                        ...
                        <EscortProfileForm user={user} cities={props.cities} escort={[]} agency={props.agency} selects={props.selects} services={props.services} />
                      </div>
                    </div>
                  </div>
                </section>
