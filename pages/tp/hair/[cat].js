...
import {getAllEscorts, getHairSeo, getAllServices, getLocals} from "../../../utils/Queries"; 
...
const Escorts = (props) => {
    ...
    const url = `/tp/hair/${seo.keyindex}`;
    ...
    return (
        <React.Fragment>
            ...
            <StatsPortfolio escorts={props.escorts} seo={props.seo} col="hair" />
...
Escorts.getInitialProps = async (ctx) => {
  ...
  const seo = await getHairSeo(cat);
