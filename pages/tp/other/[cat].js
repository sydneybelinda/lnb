...
import {getAllEscorts, getOtherSeo, getAllServices, getLocals} from "../../../utils/Queries"; 
...
const Escorts = (props) => {
    ...
    const url = `/tp/other/${seo.keyindex}`;
    ...
    return (
        <React.Fragment>
            ...
            <Portfolio escorts={props.escorts} seo={props.seo} />
